...
I build... something... sometimes.

### My Projects

- **[search-engine-for-typesense](https://github.com/lstpsche/search-engine-for-typesense)** — Mountless Rails Engine for [Typesense](https://typesense.org) usage. Expressive Relation/DSL with JOINs, grouping, presets/curation — strong DX and observability. `gem install search-engine-for-typesense`
- **[openmeteo-sh](https://github.com/lstpsche/openmeteo-sh)** — Fast, zero-bloat Bash CLI for the entire [Open-Meteo API](https://open-meteo.com). Weather, history, air quality, marine, floods, elevation, satellite — all from your terminal. Just `bash`, `curl`, and `jq`.
